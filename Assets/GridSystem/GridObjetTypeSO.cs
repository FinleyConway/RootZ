...
public class GridObjetTypeSO : ScriptableObject
{
    ...
    public Vector2Int GetRotationOffset(Dir dir)
    {
        switch (dir)
        {
            ...
            case Dir.Left: return new Vector2Int(0, GridSize.x);
            case Dir.Up: return new Vector2Int(GridSize.x, GridSize.y);
            case Dir.Right: return new Vector2Int(GridSize.y, 0);
        }
    }
